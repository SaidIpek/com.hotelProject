...
public class Driver {
    ...
    //henuz bu driver ile ilgili ayarlar yapmadigim icin baska class'lar bunu yanlislikla kulllanmasin
    //diye erisimi private yaptik(sadece bu class'in kullanimina acik yaptik).

    public static WebDriver getDriver(){


        if (driver==null) {
            //buraya yazdigimiz if'in nedeni bu method her calistiginda yeni bir driver olusturmamasi icin
            //kullaniyoruz if driver'i kontrol edecek eger bir deger atamasi yapildiysa yeni bir driver olusturmayacak
